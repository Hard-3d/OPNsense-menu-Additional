...
```sh
cd /
unzip -o /root/opnsense-additional-menu-v0.1.24-root.zip
...
- tag: `v0.1.24`
- asset: `opnsense-additional-menu-v0.1.24-root.zip`

В самой странице **Update** укажите:

```text
Repository URL: https://github.com/OWNER/REPO
Release asset name: opnsense-additional-menu-v0.1.24-root.zip
```
...
2. Создайте новый git tag, например `v0.1.24`.
...
- Rollback of v0.1.24: removed automatic udp2raw restart before WireGuard restart in Status WireGuard.
- WireGuard check behavior returned to v0.1.24 logic: on degradation it restarts WireGuard only.
